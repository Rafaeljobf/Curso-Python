...
caminho = os.path.join('Desktop', 'Faculdade', 'curso_python', 'arquivo.txt')
...
caminho_existente = 'C:\\Users\\windows 10 pro\\Desktop\\Faculdade\\curso_python\\aula_2_os.py'
print(os.path.exists(caminho_existente))
print(os.path.basename(caminho_existente))